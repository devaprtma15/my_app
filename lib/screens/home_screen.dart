...
class HomeScreen extends StatelessWidget {
  ...
  Widget _buildCarousel() {
    return Container(
      ...
      child: PageView(
        children: [
          _buildCarouselItem('assets/images/pantai1.png'),
          _buildCarouselItem('assets/images/pantai2.png'),
          _buildCarouselItem('assets/images/tanah3.png'),
        ],
      ),
    );
  }
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        return _buildAuctionItem(
          ...
          'assets/images/pantai${index + 1}.png',
        );
      },
    );
  }
